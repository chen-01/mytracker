...
function [results] = AutoTrack_optimized(params)
    ...
    for frame = 1:num_frames
        ...
        %% main loop
        occ = false;
        current_search_expansion = search_expansion;
        ...
        if visualization == 1
            ...
            search_rect_vis = [pos([2, 1]) - sz * currentScaleFactor * current_search_expansion / 2, sz * currentScaleFactor * current_search_expansion];
            ...
            text(12, 190, ['Max Val : ' num2str(max_val)], 'color', [1 0 0], 'BackgroundColor', [1 1 1], 'fontsize', 12);
