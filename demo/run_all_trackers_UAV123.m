...
function run_all_trackers_UAV123()
    ...
    where_is_your_groundtruth_folder = 'E:\code-file\desk\无人机目标跟踪算法\数据集\UAV123\UAV123_10fps\anno\UAV123_10fps'; % path that containing all groundtruth files
    where_is_your_UAV123_database_folder = 'E:\code-file\desk\无人机目标跟踪算法\数据集\UAV123\UAV123_10fps\data_seq\UAV123_10fps'; % path that containing all image sequences
    ...
    dir_output = dir(fullfile(ground_truth_folder, '\bike3.txt'));
    ...
    save_dir = [main_folder '\all_trk_results\UAV123_10fps\'];
    ...
    for tracker_count = 1:tracker_num
        ...
        for dataset_count = 1:dataset_num
            ...
            % main function
            run_tracker = getfield(run_trackers_info{tracker_count}, tracker_name_set{tracker_count}); %#ok<GFLD>
